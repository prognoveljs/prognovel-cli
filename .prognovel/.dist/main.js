                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 15:
                      ...
                      _iterator3 = _createForOfIteratorHelper$1(contributors.getNovelContributors(novel));
...
var fail = createCommonjsModule(function (module, exports) {
  ...
  */
  ...
  var ansiStyles = createCommonjsModule(function (module) {
    ...
    var makeDynamicStyles = function makeDynamicStyles(wrap, targetSpace, identity, isBackground) {
      ...
      for (var _i4 = 0, _Object$entries = Object.entries(colorConvert$1); _i4 < _Object$entries.length; _i4++) {
    ...
    function assembleStyles() {
      ...
      for (var _i5 = 0, _Object$entries2 = Object.entries(styles); _i5 < _Object$entries2.length; _i5++) {
        var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i5], 2),
            groupName = _Object$entries2$_i[0],
            group = _Object$entries2$_i[1];

        for (var _i6 = 0, _Object$entries3 = Object.entries(group); _i6 < _Object$entries3.length; _i6++) {
  ...
  function supportsColor(haveStream, streamIsTTY) {
    ...
    if (process.platform === 'win32') {
      // Windows 10 build 10586 is the first Windows release that supports 256 colors.
      // Windows 10 build 14931 is the first release that supports 16m/TrueColor.
      var osRelease = os__default$1['default'].release().split('.');
  ...
  var supportsColor_1 = {
    supportsColor: getSupportLevel,
    stdout: translateLevel(supportsColor(true, tty__default$1['default'].isatty(1))),
    stderr: translateLevel(supportsColor(true, tty__default$1['default'].isatty(2)))
  };

  var stringReplaceAll$1 = function stringReplaceAll$1(string, substring, replacer) {
  ...
  var stringEncaseCRLFWithFirstIndex$1 = function stringEncaseCRLFWithFirstIndex$1(string, prefix, postfix, index) {
    var endIndex = 0;
    var returnValue = '';
  ...
  function buildStyle(chalk, styles) {
    ...
    for (var _i7 = 0, _Object$entries4 = Object.entries(enabled); _i7 < _Object$entries4.length; _i7++) {
      var _current;

      var _Object$entries4$_i = _slicedToArray(_Object$entries4[_i7], 2),
          styleName = _Object$entries4$_i[0],
          _styles = _Object$entries4$_i[1];
  ...
  var templates = function templates(chalk, temporary) {
    var styles = [];
    var chunks = [];
  ...
  var stdoutColor = supportsColor_1.stdout,
      stderrColor = supportsColor_1.stderr;
  var stringReplaceAll = util.stringReplaceAll,
      stringEncaseCRLFWithFirstIndex = util.stringEncaseCRLFWithFirstIndex;
  ...
  for (var _i8 = 0, _Object$entries5 = Object.entries(ansiStyles); _i8 < _Object$entries5.length; _i8++) {
    _loop();
  }
  ...
  for (var _i9 = 0, _usedModels = usedModels; _i9 < _usedModels.length; _i9++) {
    _loop2();
  }

  var _loop3 = function _loop3() {
    var model = _usedModels2[_i10];
  ...
  for (var _i10 = 0, _usedModels2 = usedModels; _i10 < _usedModels2.length; _i10++) {
    _loop3();
  }
  ...
  var chalkTag = function chalkTag(chalk) {
    for (var _len5 = arguments.length, strings = new Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
      strings[_key5 - 1] = arguments[_key5];
    }
  ...
  exports.errorImageNotFound = errorImageNotFound;
  exports.errorNovelInfoNotFound = errorNovelInfoNotFound;
  exports.errorSiteSettingsNotFound = errorSiteSettingsNotFound;
  exports.failBuild = failBuild;
});
unwrapExports(fail);
fail.errorImageNotFound;
fail.errorNovelInfoNotFound;
var fail_3 = fail.errorSiteSettingsNotFound;
fail.failBuild;
...
function addNovel(novel) {
  ...
  try {
    settings = load$2(fs.readFileSync(siteFiles().settings), "utf-8");
  } catch (_) {
    fail_3();
  }

  try {
    settings.novels = [].concat(_toConsumableArray(settings.novels || []), [novel]);
  } catch (error) {
  ...
  fs.mkdirSync("novels/".concat(novel, "/contents/volume-1"), {
    recursive: true
  });
...
function _build() {
  _build = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(opts) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            ...
            failBuild([_context2.t0], "unexpected error!", {
              label: "crash"
            });
