...
function addNovel(novel) {
  ...
  fs.copyFileSync(process.env.MAIN_PATH + "/assets/banner.jpeg", "novels/".concat(novel, "/banner.jpeg"));
  fs.copyFileSync(process.env.MAIN_PATH + "/assets/cover.png", "novels/".concat(novel, "/cover.png"));
